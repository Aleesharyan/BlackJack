...
public class Blackjack : MonoBehaviour
{
    ...
    //variable to store our current roll
    int myTotal = 0;
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown("h"))
        {
            ...
            //explain to player what has happened, check for win value
            printString = ("You rolled a " + myTotal + "\n");
            if(myTotal == 6)
            {
                printString += ("You win!");
                //tell particle system to play its particle animation
            ...
            //send printString to UI object
            //myUI.UpdateTheText(printString);
            //myParticle.PlayParticle();
    ...
    int Hit()
    {
        //genterate a random number between 1-6
